...
/**
 * @brief Parse a UBX-NAV-PVT message
 * 
 * @param paylaod: Pointer to payload of UBX-NAV-PVT message
 * @param payload_len: Length of payload
 * @param nav_pvt: Pointer to store each UBX-NAV-PVT field
 * 
 * @retval
 *      - ESP_OK: Success
