...
#define GNSS_DYNMODEL_DEFAULT               UBX_CFG_NAV5_DYNMODEL_PORTABLE      /* Default dynamic platform model */
#define GNSS_PROTOCOL_DEFAULT               GNSS_ENABLE_UBX_ONLY                /* Default device communication protocol */
